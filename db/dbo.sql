...
CREATE TABLE [dbo].[employee] (
  ...
  [date_entry] date DEFAULT getdate() NULL,
...
INSERT INTO [dbo].[employee] ([id], [name], [paternal_surname], [maternal_surname], [date_entry], [birthday], [email], [departament_id], [type_employee_id], [active], [create_date]) VALUES (N'2', N'Sebastian David', N'Torres', N'Chavez', N'2020-01-19', N'1991-08-02', N'sebasdtc@outlook.com', N'1', N'1', N'1', N'2025-01-08 20:05:41.033')
GO

INSERT INTO [dbo].[employee] ([id], [name], [paternal_surname], [maternal_surname], [date_entry], [birthday], [email], [departament_id], [type_employee_id], [active], [create_date]) VALUES (N'3', N'Miguel Angel', N'Zavaleta', N'Chavez', N'2022-10-01', N'1999-07-23', N'mzavaleta@programming.com', N'4', N'2', N'1', N'2025-01-08 21:26:39.173')
GO

INSERT INTO [dbo].[employee] ([id], [name], [paternal_surname], [maternal_surname], [date_entry], [birthday], [email], [departament_id], [type_employee_id], [active], [create_date]) VALUES (N'4', N'Jose espinoza', N'Elber', NULL, N'2020-12-10', N'1999-10-12', N'jt_2022@gamil.com', N'3', N'1', N'0', N'2025-01-12 12:24:16.640')
GO

INSERT INTO [dbo].[employee] ([id], [name], [paternal_surname], [maternal_surname], [date_entry], [birthday], [email], [departament_id], [type_employee_id], [active], [create_date]) VALUES (N'5', N'Flavia', N'Torres', N'Robles', N'2020-10-19', N'2020-10-19', N'ftorres@gmail.com', N'9', N'2', N'1', N'2025-01-26 22:48:31.847')
GO
...
INSERT INTO [dbo].[employee_type] ([id], [name], [days_per_year], [active], [create_date]) VALUES (N'1', N'employee internacionales', N'21', N'1', N'2025-01-03 23:01:14.317')
GO

INSERT INTO [dbo].[employee_type] ([id], [name], [days_per_year], [active], [create_date]) VALUES (N'2', N'employee locales profesionales', N'16', N'1', N'2025-01-03 23:01:25.023')
GO

INSERT INTO [dbo].[employee_type] ([id], [name], [days_per_year], [active], [create_date]) VALUES (N'3', N'employee locales no profesionales', N'14', N'1', N'2025-01-03 23:01:42.333')
GO
...
ALTER TABLE [dbo].[employee] ADD CONSTRAINT [FK__employee__id_ti__5629CD9C] FOREIGN KEY ([type_employee_id]) REFERENCES [dbo].[employee_type] ([id]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
